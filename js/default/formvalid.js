...
RegExps.isContact = /^(((\(\d{2,3}\))|(\d{3}\-))?(13|14|15|16|17|18|19)\d{9})|(((\(\d{2,3}\))|(\d{3}\-))?(\(0\d{2,3}\)|0\d{2,3}-)?[1-9]\d{6,7}(\-\d{1,4})?)$/;
...
RegExps.isChinese = /^[\u0391-\uFFE5]+$/;
RegExps.isNickname = /^[\u4e00-\u9fa5A-Za-z0-9-_]*$/; //只能中英文，数字，下划线，减号
RegExps.isUrl = /^http[s]?:\/\/[A-Za-z0-9]+\.[A-Za-z0-9]+[\/=\?%\-&_~`@[\]\':+!]*([^<>\"\"])*$/;
RegExps.isDate = /^\d{4}-\d{1,2}-\d{1,2}$/;
RegExps.isTime = /^\d{4}-\d{1,2}-\d{1,2}\s\d{1,2}:\d{1,2}:\d{1,2}$/;
RegExps.isWeixin = /^[a-zA-Z\d_]{5,}$/;
RegExps.isRegnum = /^\d{15}$/;
RegExps.is_credit_code = /^\d{18}$/;