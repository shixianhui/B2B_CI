...
<tr id="id_<?php echo $menu['id']; ?>"  onMouseOver="this.style.backgroundColor='#ECF7FE'" onMouseOut="this.style.background='#FFFFFF'">
 ...
 <td class="align_c"><input class="input_blur" name="sort[]" id="sort_<?php echo $menu['id']; ?>"  type="text" size="3" value="<?php echo $menu['sort']; ?>" style="background-color:#E0E0E0;" ></td>
...
<tr id="id_<?php echo $subMenu['id']; ?>" onMouseOver="this.style.backgroundColor='#ECF7FE'" onMouseOut="this.style.background='#FFFFFF'">
 ...
 <td title="<?php echo "静态地址：{$subMenu['html_path']}\n【SEO栏目名称：】".clearstring($subMenu['seo_menu_name'])."\n【关键词：】".clearstring($subMenu['keyword'])."\n【描述：】".clearstring($subMenu['abstract']); ?>">&nbsp;&nbsp;┣<a href="javascript:void(0);"><span class=""><?php echo $subMenu['menu_name']; ?></span></a><?php if ($subMenu['en_menu_name']){ echo '['.$subMenu['en_menu_name'].']';} ?>
 <?php if ($subMenu['brand_ids']) { ?>
 品牌：<?php echo $subMenu['brand_ids']; ?>
 <?php } ?>
  <?php if ($subMenu['product_category_ids']) { ?>
&nbsp;产品分类：<?php echo $subMenu['product_category_ids']; ?>
 <?php } ?>
 </td>
...
<tr id="id_<?php echo $sSubMenu['id']; ?>" onMouseOver="this.style.backgroundColor='#ECF7FE'" onMouseOut="this.style.background='#FFFFFF'">
...
<tr id="id_<?php echo $sSubMenu4['id']; ?>" onMouseOver="this.style.backgroundColor='#ECF7FE'" onMouseOut="this.style.background='#FFFFFF'">
...
<tr id="id_<?php echo $sSubMenu5['id']; ?>" onMouseOver="this.style.backgroundColor='#ECF7FE'" onMouseOut="this.style.background='#FFFFFF'">
