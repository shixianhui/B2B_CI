...
<tbody>
<tr>
<td class="align_c">商场名称 <input class="input_blur" name="title" id="title" size="20" type="text">&nbsp;
<select class="input_blur" name="select_category_id" onchange="#">
<option value="">--选择商场分类--</option>
...
<select class="input_blur" name="site_category_1">
...
<th width="50">排序</th>
<th>商场名称</th>
<th width="100">商场LOGO</th>
<th width="150">商场分类</th>
...
<td class="align_c"><a data-lightbox="image_list_<?php echo $key; ?>" data-title="" href="<?php echo $value['path']; ?>"><img src="<?php if ($value['path']){echo preg_replace('/\./', '_thumb.', $value['path']);} ?>" onerror="javascript:this.src='images/admin/no_pic.png';" width="65" height="30" /></a></td>
<td class="align_c"><?php echo $value['menu_name'] ?></td>
<td class="align_c"><?php echo $value['city_name'] ?></td>
