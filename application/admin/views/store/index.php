...
<form name="search" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" >
    <table class="table_form" cellpadding="0" cellspacing="1">
        ...
        <tr>
            <td class="align_c">
                店铺编号 <input class="input_blur" name="id" id="id" size="10" type="text">&nbsp;
                用户名 <input class="input_blur" name="username" id="username" size="10" type="text">&nbsp;
                店主姓名 <input class="input_blur" name="owner_name" id="owner_name" size="10" type="text">&nbsp;
                店铺名称 <input class="input_blur" name="store_name" id="store_name" size="20" type="text">&nbsp;
