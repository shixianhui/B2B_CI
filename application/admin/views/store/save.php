...
<table class="table_form" cellpadding="0" cellspacing="1">
  <caption>基本信息</caption>
    ...
    <tr>
        <th width="20%">
             <strong>所属商场</strong> <br/>
        </th>
        <td>
            <select onchange="javascript:get_theme_list(this);" class="input_blur" name="market_id" id="market_id">
                <option value="0" >请选择所属商场</option>
                <?php if ($market_list) { ?>
                    <?php foreach ($market_list as $key=>$value) {
                        $selector = '';
                        if ($item_info) {
                            if ($item_info['market_id'] == $value['id']) {
                                $selector = 'selected="selected"';
                            }
                        }
                        ?>
                        <option <?php echo $selector; ?> value="<?php echo $value['id']; ?>"><?php echo $value['title']; ?></option>
                    <?php }} ?>
            </select>
        </td>
    </tr>
    ...
    <?php if(! empty($item_info)){ ?>
        <?php if ($item_info['auth_store_type'] == 1){ ?>
            <tr>
                <th width="20%">
                    <strong>注册号</strong> <br/>
                </th>
                <td>
                    <input name="reg_num" id="reg_num" value="<?php if(! empty($item_info)){ echo $item_info['reg_num'];} ?>" size="20" type="text">
                </td>
            </tr>
            <tr>
                <th width="20%">
                ...
                <td>
                    <input name="license_store_name" id="license_store_name" value="<?php if(! empty($item_info)){ echo $item_info['license_store_name'];} ?>" size="40" type="text">
                </td>
            </tr>
            <tr>
                <th width="20%">
                    <strong>经营者姓名</strong> <br/>
                </th>
                <td>
                    <input name="license_username" id="license_username" value="<?php if(! empty($item_info)){ echo $item_info['license_username'];} ?>" size="20" type="text">
                </td>
            </tr>
            <tr>
                <th width="20%">
                    <strong>组成形式</strong> <br/>
                </th>
                <td>
                    <input name="license_form" id="license_form" value="<?php if(! empty($item_info)){ echo $item_info['license_form'];} ?>" size="20" type="text">
                </td>
            </tr>
            <tr>
                <th width="20%">
                    <strong>经营场所</strong> <br/>
                </th>
                <td>
                    <input name="license_place" id="license_place" value="<?php if(! empty($item_info)){ echo $item_info['license_place'];} ?>" size="80" type="text">
                </td>
            </tr>
            ...
            <tr>
                <th width="20%">
                    <strong>统一社会信用代码</strong> <br/>
                </th>
                <td>
                    <input name="license_credit_code" id="license_credit_code" value="<?php if(! empty($item_info)){ echo $item_info['license_credit_code'];} ?>" size="20" type="text">
                </td>
            </tr>
            <tr>
                <th width="20%">
            ...
            <tr>
                ...
                <td>
                    <input name="license_store_type" id="license_store_type" value="<?php if(! empty($item_info)){ echo $item_info['license_store_type'];} ?>" size="20" type="text">
                </td>
            </tr>
            <tr>
                <th width="20%">
                ...
                <td>
                    <input name="license_residence" id="license_residence" value="<?php if(! empty($item_info)){ echo $item_info['license_residence'];} ?>" size="80" type="text">
                </td>
            </tr>
            <tr>
                <th width="20%">
                    <strong>法定代表人</strong> <br/>
                </th>
                <td>
                    <input name="license_representative" id="license_representative" value="<?php if(! empty($item_info)){ echo $item_info['license_representative'];} ?>" size="20" type="text">
                </td>
            </tr>
            <tr>
                <th width="20%">
                    <strong>注册资本</strong> <br/>
                </th>
                <td>
                    <input name="license_capital" id="license_capital" value="<?php if(! empty($item_info)){ echo $item_info['license_capital'];} ?>" size="20" type="text">
                </td>
            </tr>
            <tr>
                <th width="20%">
                    <strong>成立日期</strong> <br/>
                </th>
                <td>
                    <input name="license_made_time" id="license_made_time" value="<?php if(! empty($item_info)){ echo $item_info['license_made_time'];} ?>" size="20" type="text">
                </td>
            </tr>
            <tr>
                <th width="20%">
                    <strong>营业期限</strong> <br/>
                </th>
                <td>
                    <input name="license_time_limit" id="license_time_limit" value="<?php if(! empty($item_info)){ echo $item_info['license_time_limit'];} ?>" size="50" type="text">
                </td>
            </tr>
        ...
        <tr>
            ...
            <td>
                <textarea name="license_business_scope" id="license_business_scope" rows="4" cols="50"  class="textarea_style"><?php if(! empty($item_info)){ echo $item_info['license_business_scope'];} ?></textarea>
            </td>
        </tr>
    ...
    <td>
    <label title="显示在本地实体商家右侧"><input class="checkbox_style" name="custom_attribute[]" id="h"  value="h" <?php if(! empty($item_info)){if(substr_count($item_info['custom_attribute'], "h")>0){echo "checked=true";}} ?> type="checkbox"/> 热门商家[h]</label>
	<label title="显示到首页的实体商家"><input class="checkbox_style" name="custom_attribute[]" id="c"  value="c" <?php if(! empty($item_info)){if(substr_count($item_info['custom_attribute'], "c")>0){echo "checked=true";}} ?> type="checkbox"/> 首页实体商家[c]</label>
	<label title="显示到首页的实力电商"><input class="checkbox_style" name="custom_attribute[]" id="a"  value="a" <?php if(! empty($item_info)){if(substr_count($item_info['custom_attribute'], "a")>0){echo "checked=true";}} ?> type="checkbox"/> 首页实力电商[a]</label>
    ...
    <tr>
        ...
        <td>
            <a title="点击查看大图" href="<?php if ($item_info && $item_info['id_card_path_1']){echo $item_info['id_card_path_1'];}else{echo 'images/admin/no_pic.png';} ?>" target="_blank" style="float:left;"><img width="60px" height="60px" src="<?php if ($item_info && $item_info['id_card_path_1']){echo preg_replace('/\./', '_thumb.', $item_info['id_card_path_1']);}else{echo 'images/admin/no_pic.png';} ?>" /></a>
        </td>
    </tr>
    <tr>
        <th width="20%">
            <strong>身份证反面照片</strong> <br/>
        </th>
        <td>
            <a title="点击查看大图" href="<?php if ($item_info && $item_info['id_card_path_2']){echo $item_info['id_card_path_2'];}else{echo 'images/admin/no_pic.png';} ?>" target="_blank" style="float:left;"><img width="60px" height="60px" src="<?php if ($item_info && $item_info['id_card_path_2']){echo preg_replace('/\./', '_thumb.', $item_info['id_card_path_2']);}else{echo 'images/admin/no_pic.png';} ?>" /></a>
        </td>
    </tr>
    <tr>
        <th width="20%">
            <strong>营业执照照片</strong> <br/>
        </th>
        <td>
            <a title="点击查看大图" href="<?php if ($item_info && $item_info['license_path']){echo $item_info['license_path'];}else{echo 'images/admin/no_pic.png';} ?>" target="_blank" style="float:left;"><img width="60px" height="60px" src="<?php if ($item_info && $item_info['license_path']){echo preg_replace('/\./', '_thumb.', $item_info['license_path']);}else{echo 'images/admin/no_pic.png';} ?>" /></a>
        </td>
    </tr>
    <tr>
      <th width="20%">
...
<table class="table_form" cellpadding="0" cellspacing="1">
  <caption>其它信息</caption>
    ...
    <tr>
      <th width="20%"> <strong>经营范围</strong> <br/>
	  </th>
      <td>
