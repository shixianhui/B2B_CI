...
<table class="table_form" cellpadding="0" cellspacing="1">
  <caption>基本信息</caption>
	...
	<tr>
      <th width="20%">
      <font color="red">*</font> <strong>材质名称</strong> <br/>
	  </th>
      <td>
      <input valid="required" errmsg="材质名称不能为空!" name="material_name" id="material_name" value="<?php if(! empty($item_info)){ echo $item_info['material_name'];} ?>" size="80" type="text">
