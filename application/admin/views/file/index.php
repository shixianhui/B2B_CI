...
<tr id="<?php echo preg_replace('/\//', ':', $path . $value["fileName"]); ?>" onMouseOver="this.style.backgroundColor='#ECF7FE'" onMouseOut="this.style.background='#FFFFFF'">
 <td align='left'>
 ...
 <img src="<?php echo preg_replace('/\./', '_thumb.', $path . $value["fileName"]); ?>" width="80px" />
 <br/>
