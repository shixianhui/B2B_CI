            ...
            <tr>
                ...
                <td>
                    <table class="table_form" cellpadding="0" cellspacing="1" style="width:700px;margin-left:0px;">
                        ...
                        <td colspan="4">
                            <button type="button" onclick="javascript:window.open('<?php echo base_url(); ?>admincp.php/product/selector', 'add', 'top=100, left=200, width=900, height=400, scrollbars=1, resizable=yes');" class="button_style"><span>请选择活动商品</span></button>
