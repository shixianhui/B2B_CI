...
<table class="table_form" cellpadding="0" cellspacing="1">
  <caption>基本信息</caption>
	...
	<tr>
      <th width="20%">
      <font color="red">*</font> <strong>皮革名称</strong> <br/>
	  </th>
      <td>
      <input valid="required" errmsg="皮革名称不能为空!" name="leather_name" id="leather_name" value="<?php if(! empty($item_info)){ echo $item_info['leather_name'];} ?>" size="80" type="text">
