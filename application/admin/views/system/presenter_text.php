...
<table class="table_form" cellpadding="0" cellspacing="1">
  <caption>服务协议</caption>
 	...
 	<tr>
	  ...
	  <font color="red">注：1、城市合伙人、店面分销商购买商品不产生分成；2、只有顾客的购买产生分成；</font>
	</td>
	</tr>
 	<tr>
      <th width="20%">
...
<script type="text/javascript">
	...
	<tr>
      <th width="20%">
      <strong>推广页面介绍[店面分销商]</strong> <br/>
      <font color="red">注：当用户为店面分销商时显示</font>
	  </th>
      <td>
...
<script type="text/javascript">
	...
	<tr>
      <th width="20%">
      <strong>店面分销商加盟</strong>[手机上展示]<br/>
	  </th>
      <td>
