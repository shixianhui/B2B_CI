...
<table class="table_form" cellpadding="0" cellspacing="1">
  ...
  <tr>
    <td>
    <?php if ($table == 'comment' || $table == 'exchange' || $table == 'supply' || $table == 'demand') { ?>
    <a href="javascript:void(0);"><span id="<?php echo $table; ?>_save">审核<?php echo $title; ?></span></a> |
    <?php } else { ?>
    ...
    <?php if ($table == 'brand' || $table == 'style' || $table == 'material' || $table == 'store' || $table == 'filler' || $table == 'leather' || $table == 'fabric') {?>
