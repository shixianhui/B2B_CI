...
$("#path_src_a", window.parent.document).attr("href", '<?php echo $filePath; ?>');
$("#path_src", window.parent.document).attr("src", '<?php echo preg_replace('/\./', '_thumb.', $filePath).'?v='.rand(10000, 99999); ?>');
$("#path_ddd", window.parent.document).val('<?php echo $filePath; ?>');
<?php } ?>
</script>