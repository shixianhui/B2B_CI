    ...
    <tbody>
        ...
        foreach ($item_list as $item) {
            ...
            <tr id="id_<?php echo $item['id'] ?>"  onMouseOver="this.style.backgroundColor = '#ECF7FE'" onMouseOut="this.style.background = ''">
                ...
                <td class="align_c" width="400"><?php echo date('Y-m-d H:i:s', $item['start_time']) . '～' . date('Y-m-d H:i:s', $item['end_time']); ?>
                    <?php
                    if( $item['is_success']){
                        echo  '<font color="red">已成团</font>';
                    }else{
                ...
                <td class="align_c"><?php echo $item['pintuan_people']; ?></td>
                <td class="align_c">
