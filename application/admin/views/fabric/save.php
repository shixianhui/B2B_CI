...
<table class="table_form" cellpadding="0" cellspacing="1">
  <caption>基本信息</caption>
	...
	<tr>
      <th width="20%">
      <font color="red">*</font> <strong>面料名称</strong> <br/>
	  </th>
      <td>
      <input valid="required" errmsg="面料名称不能为空!" name="fabric_name" id="fabric_name" value="<?php if(! empty($item_info)){ echo $item_info['fabric_name'];} ?>" size="80" type="text">
