<div class="member_right mt20">
	<div class="box_shadow clearfix m_border">
		<div class="member_title"><span class="bt">新增皮革</span><span style="float: right;font-size:16px;"><a href="<?php echo getBaseUrl(false, '', 'seller/my_get_leather_list.html', $client_index) ?>" style="color:#333;">返回</a></span></div>
		<form action="<?php echo $_SERVER['REQUEST_URI'];?>" method="post" name="jsonForm" id="jsonForm">
			<div class="b_shop_update">
				<ul class="m_form fl">
					<li class="clearfix"><span>皮革名称：</span><input type="text" name="leather_name" id="leather_name" value="<?php if($item_info){ echo $item_info['leather_name'];}?>" valid="required" errmsg="皮革名称不能为空" class="input_txt">
