<div class="member_right mt20">
	<div class="box_shadow clearfix m_border">
		<div class="member_title"><span class="bt">新增填充物</span><span style="float: right;font-size:16px;"><a href="<?php echo getBaseUrl(false, '', 'seller/my_get_filler_list.html', $client_index) ?>" style="color:#333;">返回</a></span></div>
		<form action="<?php echo $_SERVER['REQUEST_URI'];?>" method="post" name="jsonForm" id="jsonForm">
			<div class="b_shop_update">
				<ul class="m_form fl">
					<li class="clearfix"><span>填充物名称：</span><input type="text" name="filler_name" id="filler_name" value="<?php if($item_info){ echo $item_info['filler_name'];}?>" valid="required" errmsg="填充物名称不能为空" class="input_txt">
