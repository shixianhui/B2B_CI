    ...
    <div class="box_shadow clearfix m_border">
        ...
        <div class="b_shop_update">
            <ul class="m_form fl">
                ...
                <li class="clearfix">
                    <span>分类名称：</span><input type="text" name="product_category_name" id="product_category_name" value="<?php if($item_info){ echo $item_info['product_category_name'];}?>" valid="required" maxlength="100" errmsg="品牌名称不能为空" placeholder="" class="input_txt">
                ...
                <li class="clearfix">
                 ...
                 <li class="clearfix"><span>排序：</span><input type="text" name="sort" id="sort" valid="isInt" errmsg="排序只能是数字" value="<?php if($item_info){ echo $item_info['sort'];}?>" class="input_txt"></li>
            </ul>
        </div>
        <div class="clear"></div>
