		...
		<form action="<?php echo $_SERVER['REQUEST_URI'];?>" method="post" name="jsonForm" id="jsonForm">
			<div class="b_shop_update">
				<ul class="m_form fl">
                    ...
                    <li class="clearfix"><span>QQ号：</span>
                        <input class="input_txt" name="qq_number" id="qq_number" value="<?php if(! empty($item_info)){ echo $item_info['qq_number'];} ?>" size="50" valid="isQQ" errmsg="QQ号格式错误!" type="text">
                    </li>
