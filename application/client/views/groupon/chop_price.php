    ...
    <div class="product_detail clearfix">
                    ...
                    <ul id="scrollpic">
                        ...
                        if ($attachment_list) {
                            foreach ($attachment_list as $item) {
                                ?>
                                <li><a href="#" class="pic" bigimg="<?php echo $item['path']; ?>"
                                       smallimg="<?php echo preg_replace('/\./', '_thumb.', $item['path']); ?>"><img
                                                src="<?php echo preg_replace('/\./', '_thumb.', $item['path']); ?>"/></a>
                                </li>
                                <?php
                            }
                        }
        ...
        <div class="product_info">
                ...
                <ul>
                    <li>
                        <div class="fl" style="margin-top:20px;">
                            <font class="price purple" style="padding-left:20px;"><span
                                        style="position:absolute;top:10px;left:10px;font-size:16px;">原价：</span>
                                <small>¥</small>
                                <?php
                                ...
                                ?>
                            </font><i class="ml20">当前价格范围：<font
                                        class="purple">（<?php echo number_format(min($arr) - $ptkj_record['cut_total_money'], 2); ?>
                                    ~<?php echo $item_info['sell_price']; ?>）</font></i></div>
                        <div class="buy_time fr">
                            <div class=" clearfix mb5"><font class="purple">距离拼团砍价结束时间：</font><a id="countdown"><span
                                            class="icon">01</span>小时<span class="icon">57</span>分<span
                                            class="icon">10</span>秒</a></div>
            ...
            <div class="kanjiajilu">
                ...
                <?php } ?>
                <p>当前成交价：<span
                            class="purple"><?php echo number_format($pintuan_price - $choped_price - $discount, 2); ?>
                        元</span></p>
            </div>
            <?php
    ...
    <div class="product_comment mt30" style="width:100%;">
        ...
        <div class="bd">
                ...
                <ul>
                    ...
                    if ($chop_record) {
                        foreach ($chop_record as $item) {
                            ?>
                            <Li><b><?php echo hideStar($item['chop_nickname']); ?></b>于2016-10-11
                                21:12帮<?php echo $item['nickname']; ?>砍了<span
                                        class="purple"><?php echo $item['chop_price']; ?>元</span></Li>
                        <?php }
                    } ?>
                </ul>
            </div>
            ...
            <div class="product_introduce ptkjrule">
                ...
                foreach ($pintuan_rule as $ls) {
                    ?>
                    <p>当参团人数达到<strong><?php echo $ls['low'] ?>
                            ~<?php echo $ls['high'] ?></strong>人时可享受到<strong><?php echo $ls['money'] ?>元</strong>的价格。
                    </p>
                <?php } ?>
...
<div style="height:0px;">
    <a href="index.php/user/login.html" target="_blank" id="open"></a>
</div>
        ...
        <div class="content">
            ...
            <div class="pop_kj">
                ...
                <ul style="text-align:center;" id="share">
                    <Li>
                        <a href="http://www.jiathis.com/send/?webid=cqq&url=<?php echo $url; ?>&title=<?php echo $title; ?>&pic=<?php echo $pic; ?>"
                           target="_blank" class="qq_icon"></a></Li>
                    <Li>
                        <a href="http://www.jiathis.com/send/?webid=weixin&url=<?php echo $url; ?>&title=<?php echo $title; ?>&pic=<?php echo $pic; ?>"
                           target="_blank" class="weixin_icon"></a></Li>
                    <Li>
                        <a href="http://www.jiathis.com/send/?webid=tsina&url=<?php echo $url; ?>&title=<?php echo $title; ?>&pic=<?php echo $pic; ?>"
                           target="_blank" class="sina_icon"></a></Li>
                    <Li>
                        <a href="http://www.jiathis.com/send/?webid=qzone&url=<?php echo $url; ?>&title=<?php echo $title; ?>&pic=<?php echo $pic; ?>"
                           target="_blank" class="kongjian_icon"></a></Li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="alert-box">
            ...
            <ul>
                ...
                if ($useraddressList) {
                    foreach ($useraddressList as $useraddress) {
                        ?>
                        <li class="address-item <?php echo $useraddress['default'] == 1 ? 'active' : ''; ?>"
        ...
        <div class="express">
            ...
            <a href="javascript:;" class="pay-btn"
               onclick="pay(<?php echo $ptkj_record['id']; ?>,'<?php echo number_format($pintuan_price - $choped_price - $discount, 2) ?>')">立即支付</a>
        </div>
    </div>
</div>
