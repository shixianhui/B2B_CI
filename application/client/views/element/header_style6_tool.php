...
<!--        <a href="" class="shop-logo"><img src="css/default/--><?php //echo $style; ?><!--/images/shop_logo.png"></a>-->
    ...
    <?php }
            ...
            <ul class="nav">
                <li>
                    <a href="<?php echo getBaseUrl(false, '', "store/home/{$store_id}.html", $client_index); ?>" <?php if ($this->uri->segment(2) == 'home' || $this->uri->segment(2) == 'product') {
                    echo 'class="current"';
                } ?>>店铺首页</a>
                </li>
                <?php
                $navigation_list = $this->advdbclass->get_navigation_list($store_id, 7);
                if ($navigation_list) {
    ...
    <?php }
                ...
                <Li>
                    <a href="<?php echo getBaseUrl(false, '', "store/credit/{$store_id}.html", $client_index); ?>" <?php if ($this->uri->segment(2) == 'credit') {
    echo 'class="current"';
} ?>>信誉评价</a>
                </Li>
            </ul>
