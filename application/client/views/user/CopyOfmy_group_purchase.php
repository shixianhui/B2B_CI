    ...
    <div class="member_right">
        <div class="box_shadow clearfix mt20 m_border">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="member_table mt20">
                ...
                <tr>
                    <td colspan="9">
                        <span style="color:#eb4ea1;">注：活动期间，请及时支付，过期则不可支付,支付前请确认好收货地址</span>
                    </td>
                </tr>
                <tr>
                ...
                if ($group_purchase_list) {
                    foreach ($group_purchase_list as $item) {
                        ?>
                        <tr>
                            <td align="center" class="title"><?php echo $item['name']; ?></td>
                            ...
                            <td align="center"><?php echo number_format($item['pintuan_price'] - $item['sum'], 2); ?> x <?php echo $item['buy_number']; ?> = <span class="payprice"><?php echo number_format(($item['pintuan_price'] - $item['sum']) * $item['buy_number'], 2); ?></span>元</td>
                            <td align="center">
                                <?php
...
<!--                                <a href="javascript:void();" class="m_btn" onclick="pay(<?php //echo $item['id']; ?>, $(this).parents('tr').find('.payprice').html())">去支付</a><br>-->
                        ...
                        <tr>
                            <td colspan="9">活动结束时间：<?php
                                ...
                                <?php
                                if (time() > $item['end_time']) {
                                    echo '<span style="color:#eb4ea1">活动已结束</span>';
                                } else {
                                    echo '<span style="color:#eb4ea1">进行中...</span>';
                                };
                                ?>
                            </td>
                        </tr>
    ...
    <div class="content">
        ...
        <div class="pop_kj">
            ...
            <ul style="text-align:center;" id="share">
                <Li><a href="javascript:;" target="_blank" class="qq_icon"></a></Li>
                <Li><a href="javascript:;" target="_blank" class="weixin_icon"></a></Li>
                <Li><a href="javascript:;" target="_blank" class="sina_icon"></a></Li>
                <Li><a href="javascript:;" target="_blank" class="kongjian_icon"></a></Li>
            </ul>
        </div>
    </div>
</div>
