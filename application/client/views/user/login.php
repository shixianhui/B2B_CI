...
<h3>有账号，快速登录</h3>
 ...
 <form action="<?php echo getBaseUrl(false, "user/login.html", "user/login.html", $client_index); ?>" method="post" id="jsonForm" name="jsonForm">
    ...
    <li ><a onclick="javascript:$('form').submit();" href="javascript:void(0);" class="btn_r">立即登录</a></li>
    <li><label><input type="checkbox" name="remember" value="1">记住用户名</label> <a href="<?php echo getBaseUrl($html,'user/get_pass.html','user/get_pass.html',$client_index);?>" class="f12 c9">忘记密码?</a><font color="#ccc"> |</font> <a href="<?php echo getBaseUrl($html,'user/reg.html','user/reg.html',$client_index);?>"><font class="red f12">免费注册</font></a></li>
 </form>
    <div class="other_log mt20"><span class="c9 f14">—  第三方账号登录  —</span>
    <p>
<!--    <a href="javascript:void(0);" class="weibo_icon icon"></a>-->
