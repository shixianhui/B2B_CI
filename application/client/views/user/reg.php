    ...
    <div class="log_box">
        ...
        <form action="<?php echo getBaseUrl(false, "", "user/reg.html", $client_index); ?>" method="post" id="jsonForm" name="jsonForm">
            <ul class="log_form">
                ...
                <li><label><input checked="checked" name="remember" value="1" type="checkbox">我已认真阅读并接受<a href="index.php/page/index/292/52.html" target="_blank" class="red">《蚁立网用户服务条款》</a></label></li>
            </ul>
        </form>
    </div>
    <div class="log_img">
