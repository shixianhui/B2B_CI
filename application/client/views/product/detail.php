...
<!--<div class="seat warp mt20"><a href="">首页</a> > <a href="">本地实体商家 </a> > 卧室双人床环保家具床套装</div>-->
...
<?php }} ?>
 ...
 <div class="product-info">
  <h2 class="nowrap"><?php if ($item_info){echo $item_info['title'];} ?></h2>
     <?php if ($groupon_info){ ?>
     <div class="desc">本商品正在参加<font color="#c81624">[团预购活动] </font><a href="<?php echo getBaseUrl(false,'',"groupon/detail/{$groupon_info['id']}.html",$client_index); ?>" style="color: #00a0e9">前往活动~</a></div>
     <?php } ?>
  ...
  <ul>
  <li><div class="fl" >价格<font class="price purple"><small>¥</small><?php if ($item_info){echo $item_info['sell_price'];} ?></font><i class="ml20">市场价<s>¥<?php if ($item_info){echo $item_info['market_price'];} ?></s></i></div>
  ...
  <div class="ncs-figure-input">
        ...
        <a onclick="javascript:increase();" href="javascript:void(0)" class="decrease" nctype="decrease" id="Reduce">&nbsp;</a> </div><em class="kc ml20">库存：<?php if ($item_info){echo $item_info['stock'];} ?></em><input value="<?php if ($item_info){echo $item_info['stock'];} ?>" type="hidden" id="product_stock">
  </div>
    <div class="clear"></div>
...
<div class="ncs-btn mt20">
    <?php if ($item_info && !$item_info['unclear_price']){ ?>
           <a onclick="javascript:add_now_cart();" href="javascript:void(0);"  class="buynow t-bg" title="立即购买">立即购买</a>
          <a onclick="javascript:add_cart();" href="javascript:void(0);"  class="addcart t-bg" title="加入购物车" id="add-car"><i class="icon-cart icon"></i>加入购物车</a>
    <?php } ?>
</div>
 </div>
 </div>
