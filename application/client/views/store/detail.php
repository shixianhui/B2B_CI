<div class="maincat mp ">
  ...
  <div class="cate-l f mr11">
    ...
    <div class="article_pro">
        ...
        <div class="fr">
      转载请注明出处：<a title="<?php if ($itemInfo){ echo clearstring($itemInfo['title']);} ?>" target="_blank" href="<?php echo base_url().getBaseUrl($html, "", "{$template}/detail/{$id}.html", $client_index); ?>"><?php echo base_url().getBaseUrl($html, "", "{$template}/detail/{$id}.html", $client_index); ?></a>
       </div>
     </div>
    ...
    <div class="newslist-conts-w clear-g">
		...
		?>
                <li style="width:253.33333333333331px;white-space:nowrap;overflow:hidden;float:left;"><a title="<?php echo clearstring($item['title']); ?>" target="_blank" href="<?php echo $url; ?>"><?php echo my_substr($item['title'], 50); ?></a></li>
       <?php }} ?>
          </ul>
    </div>
</div>
