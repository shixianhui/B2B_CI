<?php
class Edu_tourism_model extends CI_Model {

	private $_tableName = 'edu_tourism';
	...
	public function gets($strWhere = NULL, $limit = NULL, $offset = NULL) {
		$ret = array();
		$this->db->select("{$this->_tableName}.id, {$this->_menuTName}.html_path, {$this->_tableName}.title, {$this->_tableName}.sort, {$this->_tableName}.title_color, {$this->_tableName}.abstract, {$this->_tableName}.hits, {$this->_tableName}.author, {$this->_tableName}.category_id, {$this->_tableName}.add_time");
