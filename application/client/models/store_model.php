...
class Store_model extends CI_Model {
    ...
    public function gets($strWhere = NULL, $limit = NULL, $offset = NULL) {
        $ret = array();
        $this->db->select("{$this->_tableName}.store_name,{$this->_tableName}.txt_address,{$this->_tableName}.theme,{$this->_tableName}.store_banner,{$this->_tableName}.path,{$this->_tableName}.list_path_logo,{$this->_tableName}.description,{$this->_tableName}.business_scope,{$this->_tableName}.id,{$this->_tableName}.address");
//        $this->db->order_by("{$this->_tableName}.sort", 'RANDOM');
    ...
    public function getsRand2($strWhere = NULL, $limit = NULL, $offset = NULL) {
        $ret = array();
        $this->db->select("{$this->_tableName}.*");
