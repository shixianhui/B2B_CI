<?php
class Promotion_ptkj_model extends CI_Model {

	private $_tableName = 'promotion_ptkj';
    ...
    public function gets($strWhere = NULL, $limit = NULL, $offset = NULL) {
		$ret = array();
        $this->db->select("{$this->_tableName}.*,{$this->_productName}.title,{$this->_productName}.sell_price,{$this->_productName}.market_price,{$this->_productName}.path");
