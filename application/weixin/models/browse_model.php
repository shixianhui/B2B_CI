...
class Browse_model extends CI_Model {
	...
	public function gets2($strWhere = NULL, $limit = NULL, $offset = NULL) {
		$ret = array();
		$this->db->select("{$this->_tableName}.*, {$this->_productTName}.title, {$this->_productTName}.sell_price, {$this->_productTName}.product_num, {$this->_productTName}.path, {$this->_productTName}.path");
