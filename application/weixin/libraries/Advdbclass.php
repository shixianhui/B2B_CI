...
class Advdbclass {
    ...
    public function getScore() {
		...
		return $CI->System_model->get('login_score, register_score, product_percent, open_score', array('id'=>1));
	}
    ...
    public function getDiscount() {
		...
		return $CI->System_model->get('discount_title, discount_ad, discount_add_time, discount_end_time, discount_percent, discount_open, discount_content', array('id'=>1));
	}

    //积分兑换
    public function getExcScore() {
	    $CI = & get_instance();
		$CI->load->model('System_model', '', TRUE);

		return $CI->System_model->get('exchange_percent, exchange_open', array('id'=>1));
	}
	...
	public function get_product_brand_list() {
		...
		return $CI->Brand_model->gets('*', array('brand_category_id'=>1));
	}
